...
public class UTB extends TabFrame {
  ...
  private final HashMap<String, AccountTitle> accounts = Ledger.getUnAdjustedAccounts();
  ...
  public UTB(Journalizing journalizing) {
    ...
    this.removeActionListener(getUnadjustedTBTab());
    ...
    JLabel UTB = new JLabel("Unadjusted Trial Balance");
